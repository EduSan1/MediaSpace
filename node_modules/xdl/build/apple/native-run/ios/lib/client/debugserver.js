...
function _gdb() {
  const data = require("../protocol/gdb");
 ...
 */
const debug = (0, _debug().default)('expo:xdl:ios:lib:client:debugserver');

class DebugserverClient extends _client().ServiceClient {
  constructor(socket) {
    super(socket, new (_gdb().GDBProtocolClient)(socket));
    this.socket = socket;
  }
  ...
  async sendCommand(cmd, args) {
    ...
    const resp = await this.protocolClient.sendMessage(msg); // we need to ACK as well
