...
export const LoginInput = ({ title, value, name, iconName, handleChange, isPassword, onClickIcon, error}: ILoginInput) => {

    const [inputTitle, serInputTitle] = useState(false)

    return (

        <View style={[styles.container , error ? { borderColor: "#FF6666" } : { borderColor: "#D3C5F8" }]}>
            ...
            <View style={styles.inputContainer}>
                ...
                <Pressable style={styles.inputIcon} onPress={() => onClickIcon ? onClickIcon() : null}>
                    <Icon size={Dimensions.get('window').height * 0.025} name={iconName} style={[styles.inputIcon , error ? { color: "#FF6666" } : { color: "#46307B" } ]} />
                </Pressable>
