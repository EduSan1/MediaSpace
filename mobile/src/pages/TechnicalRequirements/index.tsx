                ...
                <SafeAreaView>
                   ...
                   <Text style={style.textValue}>Valor total do projeto: R$ 2.000,00</Text>
                    <View style={style.footerProject}>
                        ...
                        <Text>Caso esteja interessado em fazer mudanças ou adaptações nos requisitos, solicite uma revisão, só é permitido a edição assim que o cliente e o(s) prestador(es) aceitarem a solicitação.</Text>
                    </View>                    
