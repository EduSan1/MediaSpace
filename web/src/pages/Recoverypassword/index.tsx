            ...
            <div className="ContainerInputs_recoveryPassword">
                ...
                <div className="Tittle_input_btn_passWord">
                    ...
                    <span className="btn_span">
                        <InputLoign hasError={hasError} typeInput={'email'} name={'mail'} placeholder={"username@mediaspace.com"} maxlength={255} icon={<BsFillPersonFill/>} className={hasError ? "InputError" : "Input_PassWordRecovery"}
