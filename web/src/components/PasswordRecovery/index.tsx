            ...
            <div className="ContainerInputs_recoveryPassword">
                ...
                <div className="Tittle_input_btn_passWord">
                    ...
                    <span className="btn_span">
                        <InputLoign maxlength={100} label="Email" hasError={hasError} typeInput={'email'} name={'mail'} placeholder={"username@mediaspace.com"} icon={<BsFillPersonFill/>} className={hasError ? "InputError" : "Input_PassWordRecovery"}
