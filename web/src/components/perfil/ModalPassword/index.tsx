...
const ModalPassword = () => {
    ...
    return (
        ...
        <div className="Modal_all">
            ...
            <InputLogin disable={false} className="InputModalPerfil" valueLogin={password.password} handleChange={(event: React.ChangeEvent<HTMLInputElement>)=>{handleChange(event)}} hasError={false} icon={''} label={''} maxlength={255} name={'password'} placeholder={''} typeInput={'text'} />
